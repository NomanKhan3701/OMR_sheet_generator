    ...
    <div className={styles.Filter}>
      <div className={styles.form}>
        ...
        <div className={styles.form_item}>
          ...
          <input
            type="number"
            value={filters.totalQuestionInOneColumn}
            onChange={(e) =>
              setFilters((prev) => {
                return {
                  ...prev,
                  totalQuestionInOneColumn:
        ...
        <div className={styles.form_item}>
          ...
          <input
            type="number"
            value={filters.totalQuestionInOneSection}
            onChange={(e) =>
              setFilters((prev) => {
                return {
                  ...prev,
                  totalQuestionInOneSection:
                    e.target.value > 200 ? 200 : e.target.value,
                };
              })
            }
